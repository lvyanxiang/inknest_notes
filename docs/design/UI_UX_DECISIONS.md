...
|---|---|---|---|---|
| 2026-08-03 | Editor command hierarchy | Keep notebook location and ink history in the document bar; keep tools, contextual style, and touch mode in the editing dock; do not let persistent presets compete with primary tools. | Delivered | `docs/product/features/editor-workspace-v2/UI_UX_SPEC.md` |
