...
|---|---|---|---|---|
| 2026-08-03 | Editor command hierarchy | Keep notebook location and ink history in the document bar; show direct Record at regular widths and Export at wide widths; group overflow actions by Page, Document, Audio, and View; keep tools, contextual style, and touch mode in the editing dock. | Delivered | `docs/product/features/editor-workspace-v2/UI_UX_SPEC.md` |
