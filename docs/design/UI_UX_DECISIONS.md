...
| 2026-08-06 | Recently deleted recovery | Keep ordinary deletion non-blocking and reversible; expose active Tombstones through a future Recently Deleted surface, and report delete-versus-edit preservation as sync status instead of interrupting writing. | Backend delivered; App pending | `docs/product/features/inknest-cloud-backend/UI_UX_SPEC.md` |
