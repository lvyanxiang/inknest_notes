...
|---|---|---|---|---|
| 2026-08-03 | Editor workspace V2 | Separate document actions from editing mode, restore one-tap Pen/Highlighter switching, move ink history to the document bar, adapt direct Record/Export actions to available width, and keep presets inside contextual properties instead of persistent chrome. | Delivered | `docs/product/features/editor-workspace-v2/PRODUCT_BRIEF.md` |
